...
public class BlockAnimalHorseWhite extends BlockAnimal{

	public BlockAnimalHorseWhite(String name, int ID, int price) {
		super(name, ID, price);
	}
	...
	public TileEntityAnimal createTileEntity(World world, IBlockState state) {
		return new TileEntityHorseWhite(this.getUnlocalizedName());
	}
}
