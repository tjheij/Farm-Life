...
public class BlockPancakemachine extends BlockMachine{

	public BlockPancakemachine(String name, int ID) {
		super(name, ID);
	}
	...
	public TileEntityMachine createTileEntity(World world, IBlockState state) {
		return new TileEntityPancakemachine(this.getUnlocalizedName());
	}
